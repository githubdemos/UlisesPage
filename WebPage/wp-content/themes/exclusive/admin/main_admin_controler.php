...
$exclusive_theme_name=__("Exclusive Options","wd_exclusive"); /// menu theme name
...
function web_dor_theme_control_pages(){
	...
	global  $exclusive_layout_page,// layout page class
			$exclusive_general_settings_page,// general page class
			$exclusive_home_page,// home page class
			$exclusive_color_control_page,// color page class
			$exclusive_typography_page,// typography page class
			$exclusive_slider_page,// slider page class
			$exclusive_sample_date,// sample_date page class
			$exclusive_licensing_page; // licensing page class
	...
	<?php global $exclusive_show_logo; if($exclusive_show_logo){?><div style="background-image:url(<?php echo get_template_directory_uri(); ?>/images/adminheader.png);background-repeat: no-repeat; width: 90%;margin-left: 59px; height: 90px;"></div><?php }?>
	<div id="icon-themes" class="icon32"><br></div>
	<h2 class="nav-tab-wrapper">
		<a id="options-group-1-tab" class="nav-tab" title="Layout Editor" href="#options-group-1"><?php echo __("Layout Editor","wd_exclusive"); ?></a>
		<a id="options-group-2-tab" class="nav-tab" title="General" href="#options-group-2"><?php echo __("General","wd_exclusive"); ?></a>
		<a id="options-group-3-tab" class="nav-tab" title="Homepage" href="#options-group-3"><?php echo __("Homepage","wd_exclusive"); ?></a>
		<a id="options-group-4-tab" class="nav-tab" title="Color Control" href="#options-group-4"><?php echo __("Color Control","wd_exclusive"); ?></a>
		<a id="options-group-5-tab" class="nav-tab" title="Typography" href="#options-group-5"><?php echo __("Typography","wd_exclusive"); ?></a>
		<a id="options-group-6-tab" class="nav-tab" title="Slider" href="#options-group-6"><?php echo __("Slider","wd_exclusive"); ?></a>
		<a id="options-group-7-tab" class="nav-tab" title="Install Sample Data" href="#options-group-7"><?php echo __("Install Sample Data","wd_exclusive"); ?></a>	
		<a id="options-group-8-tab" class="nav-tab" title="Featured Plugins" href="#options-group-8"><?php echo __("Licensing","wd_exclusive"); ?></a>	
	</h2>
	<div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			
				<div id="options-group-1" class="group Layout" style="display: none;"><h3><?php echo __("Layout Editor","wd_exclusive"); ?></h3><?php echo $exclusive_layout_page->dorado_theme_admin_layout(); ?></div>
				<div id="options-group-2" class="group General" style="display: none;"><h3><?php echo __("General","wd_exclusive"); ?></h3><?php echo $exclusive_general_settings_page->dorado_theme_admin_general_settings(); ?></div>
				<div id="options-group-3" class="group Homepage" style="display: none;"><h3><?php echo __("Homepage","wd_exclusive"); ?></h3><?php echo $exclusive_home_page->dorado_theme_admin_home(); ?></div>
				<div id="options-group-4" class="group Color" style="display: none;"><h3><?php echo __("Color Control","wd_exclusive"); ?></h3><?php echo $exclusive_color_control_page->dorado_theme_admin_color_control(); ?></div>
				<div id="options-group-5" class="group Typography" style="display: none;"><h3><?php echo __("Typography","wd_exclusive"); ?></h3><?php echo $exclusive_typography_page->dorado_theme_admin_typography(); ?></div>
				<div id="options-group-6" class="group Slider" style="display: none;"><h3><?php echo __("Slider","wd_exclusive"); ?></h3><?php echo $exclusive_slider_page->web_dorado_theme_admin_slider(); ?></div>
				<div id="options-group-7" class="group Install" style="display: none;"><h3><?php echo __("Install Sample Data","wd_exclusive"); ?></h3><?php echo $exclusive_sample_date->exclusive_install_posts(); ?></div>
				<div id="options-group-8" class="group Licensing" style="display: none;"><h3><?php echo __("Licensing","wd_exclusive"); ?></h3><?php echo $exclusive_licensing_page->dorado_theme_admin_licensing(); ?></div>
		</div>
