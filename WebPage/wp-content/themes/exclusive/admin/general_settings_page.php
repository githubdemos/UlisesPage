	...
	function __construct(){
		...
		$this->options_generalsettings = array(
			...
			'logo_img' => array(
				...
				"name" =>  __("Logo","wd_exclusive"),
				
				"sanitize_type" => "esc_url_raw",
				
				"description" =>  __("You can apply a custom logo image by clicking on the Upload Image button and uploading your image.","wd_exclusive"),
			...
			'body_back' => array(
				...
				"name" =>  __("General Settings","wd_exclusive"),
			...
			'custom_css' => array(
				...
				"name" =>  __("Custom CSS","wd_exclusive"),
				
				"description" =>  __("Custom CSS will change the visual style of the site. This CSS code will be inserted in the &lt;head&gt; tag of your site. You can provide custom CSS code to be applied to specific elements.","wd_exclusive"),
			...
			'favicon_img' => array(
				...
				"description" =>  __("You can apply a custom favicon image by clicking on the Upload Image button and uploading your image.","wd_exclusive"),
			...
			'blog_style' => array(
				...
				"name" =>  __("Blog Style Post Format","wd_exclusive"),
				
				"description" =>  __("Here you can choose to change the format of your index/homepage posts and view them as short post previews.","wd_exclusive"),
			...
			'grab_image' => array(
				...
				"name" =>  __("Grab the First Post Image","wd_exclusive"),
				
				"description" =>  __("Enable this option if you want to use the images that are already in your post to create a thumbnail
											without using custom fields. In this case thumbnail images will be generated automatically using the
											first added image of the post. Note that the image needs to be hosted on your own server.","wd_exclusive"),
			...
			'show_twitter_icon' => array(
				...
				"name" =>  __("Show Twitter Icon","wd_exclusive"),
				
				"description" =>  __("Here you can choose to show the Twitter Icon.","wd_exclusive"),
			...
			'show_rss_icon' => array(
				...
				"name" =>  __("Show RSS Icon","wd_exclusive"),
				
				"description" => __("Here you can choose to show the RSS Icon.","wd_exclusive"),
			...
			'show_facebook_icon' => array(
				...
				"name" =>  __("Show Facebook Icon","wd_exclusive"),
				
				"description" =>  __("Here you can choose to show the Facebook Icon.","wd_exclusive"),
			...
			'twitter_url' => array(
				...
				"description" =>  __("Enter your Twitter Profile URL below.","wd_exclusive"),
			...
			'rss_url' => array(
				...
				"description" =>  __("Enter your RSS URL below.","wd_exclusive"),
			...
			'facebook_url' => array(
				...
				"description" =>  __("Enter your Facebook Profile URL below.","wd_exclusive"),
			...
			'favicon_enable' => array(
				...
				"name" =>  __("Show Favicon","wd_exclusive"),
				
				"description" =>  __("Check the box to show favicon on the site. You can add custom favicon to your homepage. Press &#34;Upload image&#34; button and choose the corresponding file if the box is checked. By default favicon is a 16 x 16 pixel file saved in favicon.ico format in root directory of the server.","wd_exclusive"),
			...
			'date_enable' => array(
				...
				"name" =>  __("Display Date to the Posts","wd_exclusive"),
				
				"description" =>  __("Choose to display date in posts whether or not.","wd_exclusive"),
			...
			'footer_text' => array(
				...
				"name" =>  __("Information in the Footer","wd_exclusive"),
				
				"description" =>  __("Here you can provide the HTML code to be inserted in the footer of your web site.","wd_exclusive"),
			...
			<table align="center" width="90%" style="margin-top: 0px;border-bottom: rgb(111, 111, 111) solid 2px;">
			    <tr>   
                     <td style="font-size:14px; font-weight:bold">
					     <a href="<?php echo $exclusive_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("User Manual","wd_exclusive"); ?></a><br /><?php echo __("This section allows you to make changes in overall content of the site.","wd_exclusive"); ?>
                         <a href="<?php echo $exclusive_web_dor.'/wordpress-theme-options/3-3.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("More...","wd_exclusive"); ?></a>
					 </td>  
				...
				<tr>
					<td>
						<h3 style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;color: rgb(111, 111, 111); font-size:18pt;"><?php echo __("General","wd_exclusive"); ?></h3>
					</td>
				</tr>
			</table>
