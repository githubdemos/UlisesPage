...
class exclusive_sample_date{
	...
	public function exclusive_install_posts(){
		...
		<div id="main_install_page">
			...
			<table align="center" width="90%" style="margin-top: 0px;border-bottom: rgb(111, 111, 111) solid 2px;">
			    <tr>   
                      <td style="font-size:14px; font-weight:bold">
					     <a href="<?php echo $exclusive_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="outline-style: none !important;color:#126094; text-decoration:none;"><?php echo __("User Manual","wd_exclusive"); ?></a><br /><?php echo __("This section allows to add sample data.","wd_exclusive"); ?>
                         <a href="<?php echo $exclusive_web_dor.'/wordpress-theme-options/3-9.html'; ?>" target="_blank" style="outline-style: none !important;color:#126094; text-decoration:none;"><?php echo __("More...","wd_exclusive"); ?></a>
					 </td>   
				...
				<tr>
					<td>
						<h3 style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;color: rgb(111, 111, 111); font-size:18pt;">Install <?php echo __("Sample Data","wd_exclusive"); ?></h3>
					</td>
				</tr>
			</table>
			...
			<div id="install_remove">
			    <p style="font-size:15px;font-weight:bold;color: #333;"><?php echo __("To get an overall impression of the theme and to get acquainted with its main capabilities we suggest you to install sample data.","wd_exclusive"); ?></p>
   ...
   <li>Pellentesque fermentum dolor. Aliquam quam lectus, elementum vulputate, nunc.</li>
			...
			case 31:{
				...
				$exclusive_home_page->update_parametr('n_of_home_post','1');				
