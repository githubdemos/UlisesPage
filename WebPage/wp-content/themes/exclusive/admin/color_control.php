	...
	function __construct(){
		...
		$this->options_colorcontrol = array(
		   "menu_elem_back_color" => array(
				...
				"name" => __("Menu Element Backround Color","wd_exclusive"),
			...
			/* "content_back_color" =>  array(
			 ...
			 "sideb_background_color" =>  array(
				...
				"name" =>  __("Sidebar Background Color","wd_exclusive"),
			 ...
			 "footer_back_color" =>  array(
				...
				"name" =>  __("Footer Background Color","wd_exclusive"),
			 ...
			 "home_top_posts_color" =>  array(
				...
				"name" =>  __("Featured Post Background Color","wd_exclusive"),
			 ...
			 "top_posts_color" =>  array(
				...
				"name" =>  __("Top Posts Background Color","wd_exclusive"),
			 ...
			 "text_headers_color" =>  array(
				...
				"name" =>  __("Header Text(&lt;h1&gt; etc) Color","wd_exclusive"),
			 ...
			 "primary_text_color" =>  array(
				...
				"name" =>  __("Primary Text Corlor","wd_exclusive"),
			 ...
			 "footer_text_color" =>  array(
				...
				"name" =>  __("Footer Text Color","wd_exclusive"),
			 ...
			 "primary_links_color" =>  array(
				...
				"name" =>  __("Primary Links","wd_exclusive"),
			 ...
			 "primary_links_hover_color" =>  array(
				...
				"name" =>  __("Primary Links Hover","wd_exclusive"),
			 ...
			 "menu_links_color" =>  array(
				...
				"name" =>  __("Menu Links","wd_exclusive"),
			 ...
			 "menu_links_hover_color" =>  array(
				...
				"name" =>  __("Menu Links Hover","wd_exclusive"),
			 ...
			 "menu_color" =>  array(
				...
				"name" =>  __("Hover Menu Item","wd_exclusive"),
			 ...
			 "selected_menu_color" =>  array(
				...
				"name" =>  __("Selected Menu Item","wd_exclusive"),
			 ...
			 "logo_text_color" =>  array(
				...
				"name" =>  __("Logo Text Color ","wd_exclusive"),
			...
			"logo_text_color_for_phone" =>  array(
				...
				"name" =>  __("Logo Text Color For Phone","wd_exclusive"),
			...
			<table align="center" width="90%" style="margin-top: 0px;border-bottom: rgb(111, 111, 111) solid 2px;">
			    <tr>   
                      <td style="font-size:14px; font-weight:bold">
					     <a href="<?php echo $exclusive_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("User Manual","wd_exclusive"); ?></a><br /><?php echo __("This section allows you customize the color features.","wd_exclusive"); ?>
                         <a href="<?php echo $exclusive_web_dor.'/wordpress-theme-options/3-6.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("More...","wd_exclusive"); ?></a>
					 </td>    
				...
				<tr>
					<td style="height: 70px;"><h3 style="margin: 0px;font-family:Segoe UI;color: rgb(111, 111, 111); font-size:18pt;"><?php echo __("Color Control","wd_exclusive"); ?></h3></td>
				</tr>
			</table>
		  <div style="margin: 0 auto;width:90%;padding-bottom:0px; padding-top:0px;">		
			<div class="optiontitle" style="">
				  <p style="font-size:15px;font-weight:bold;color: #333;"><?php echo __("The color customization parameters are disabled in free version. Please buy the commercial version in order to enable this functionality.","wd_exclusive"); ?></p>
