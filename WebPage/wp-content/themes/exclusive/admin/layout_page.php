...
class web_dor_layout_page_class{
	...
	function __construct(){
		...
		global $exclusive_special_id_for_db,$pcontent_area;
		
		$this->themeoptions = "Layout Editor";
		
		$this->shortthemeoptions = $exclusive_special_id_for_db."gs";
		...
		$this->options_themeoptions = array (
			...
			"default_layout" => array( 
				...
				"name" => __("Choose Default Layout","wd_exclusive"),
		
				"description" => __("Here you can select the default layout for pages and posts on the website.","wd_exclusive"),
			...
			"full_width" =>array( 
				...
				"name" => __("Full Width","wd_exclusive"),
			...
			"content_area" =>array( 
				...
				"name" => __("Content Area Width","wd_exclusive"),
		
				"description" => __("Specify the width of the Content Area","wd_exclusive"),
			...
			"main_column" =>array( 
				...
				"name" => __("Main Column Width","wd_exclusive"),
		
				"description" => __("Specify the width of the Main Column","wd_exclusive"),
			...
			"pwa_width" =>array( 
				...
				"name" => __("Primary Widget Area width","wd_exclusive"),
		
				"description" => __("Specify the width of the Primary Widget Area","wd_exclusive"),
				...
				<tbody>
				    <tr>   
                      <td style="font-size:14px; font-weight:bold">
					     <a href="<?php echo $exclusive_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("User Manual","wd_exclusive"); ?></a><br /><?php echo __("This section allows you to make changes in default layout of the theme.","wd_exclusive"); ?>
                         <a href="<?php echo $exclusive_web_dor.'/wordpress-theme-options/3-2.html'; ?>" target="_blank" style="color:#126094; text-decoration:none;"><?php echo __("More...","wd_exclusive"); ?></a>
					    </td>   
					...
					<tr>
						<td>
							<h3 style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;color: rgb(111, 111, 111); font-size:18pt;"><?php echo __("Layout Editor","wd_exclusive"); ?></h3>
						</td>						
					</tr>
				</tbody>
			</table>
					...
					<tr>
						<td>
							...
							<table width="100%">
						     ...
						     <div>
								<?php	$exclusive_admin_helepr_functions->only_checkbox($this->options_themeoptions['full_width']); ?>
								<?php for($i=0;$i<$count_text;$i++) {
									$exclusive_admin_helepr_functions->only_input($text[$i],array("input_size"=>"4"));
								 } 			
								 ?>
