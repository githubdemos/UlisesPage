					...
					<tbody>
						<tr>   
						  <td style="font-size:14px; font-weight:bold;color: #333;">
							 <a href="<?php echo $exclusive_web_dor.'/wordpress-themes-guide-step-1.html'; ?>" target="_blank" style="outline-style: none !important;color:#126094; text-decoration:none;"><?php echo __("User Manual","wd_exclusive"); ?></a><br /><?php echo __("This section allows you customize the slider.","wd_exclusive"); ?>
							 <a href="<?php echo $exclusive_web_dor.'/wordpress-theme-options/3-8.html'; ?>" target="_blank" style="outline-style: none !important;color:#126094; text-decoration:none;"><?php echo __("More...","wd_exclusive"); ?></a>
						 </td>   
						...
						<tr>
							<td>
								<h3 style="margin: 0px;font-family:Segoe UI;padding-bottom: 15px;color: rgb(111, 111, 111); font-size:18pt;font-weight: bold;"><?php echo __("Slider","wd_exclusive"); ?></h3>
							</td>
						</tr>
					</tbody>
				</table>		
...
<table class="optioninput" width="800">
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Slider Height","wd_exclusive").'
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Animation Speed","wd_exclusive").'
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Pause Time","wd_exclusive").'
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Stop animation while hovering","wd_exclusive").'
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Effect","wd_exclusive").'
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Title Position","wd_exclusive").'
        <span class="hasTip" style="cursor: pointer;color: #3B5998;" title="The animation of the slider can be customized with the help of various effects. You can choose the slider animation effect from the list included below.">[?]</span>
        </h3></td>
		<td>
	...
	<tr>
		<td width="30%"  valign="middle"><h3>'.__("Description Position","wd_exclusive").'
        <span class="hasTip" style="cursor: pointer;color: #3B5998;" title="The animation of the slider can be customized with the help of various effects. You can choose the slider animation effect from the list included below.">[?]</span>
        </h3></td>
		<td>
			<table class="bws_position_table">
	...
	<tr id="add-image-line">
		<td width="30%"  valign="middle"><h3>'.__("Image","wd_exclusive").'
